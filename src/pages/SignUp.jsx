...
name:""
  ...
  return (
    <section className='max-w-6xl mx-auto px-4'>
        <h4 className='text-center font-bold text-3xl mt-6'>Sign up</h4>
            ...
            <div className='w-full md:w-8/12 lg:w-5/12 lg:ml-20'>
                ...
                <input className='w-full px-4 py-2 mb-5 text-gray-700 font-medium text-xl border-gray-300 rounded
                    ...
                    <div className='flex justify-between items-center whitespace-nowrap text-sm sm:text-lg mt-4'>
                        <p >Have an account?
                        <Link to="/sign-in" className='text-red-600 hover:text-red-700 transition duration-200'>Sign in</Link></p>
                    ...
                    <button type="submit" onSubmit={signUpSubmit}
